...
/**
 * Interface representing the main operations of a Stack abstract data type.
 * <br>
 */
public interface InterStack<T> {
    ...
    /**
     * Deletes (pops) the first element of the Stack, moves the next element to the
     * top of the stack and returns the deleted one upon deletion. <br>
     * 
